...
if __name__ == "__main__":
    ...
    loop = SoftRealtimeLoop(dt = 1/FREQUENCY, report=True)
    ...
    with open(L_exo_filename, 'a') as fd:
        ...
        for t in loop:
            ...
            if current_time_in_stride >= stride_period:
                ...
                current_time_in_stride = t - sim_start_time
            ...
            exo_left.thermalModel.update(dt=dt, motor_current=actpack_current)
