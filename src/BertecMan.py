...
class Bertec:
    ...
    def __init__(self, viconPC_IP="141.212.77.30", viconPC_BertecPort=4000):
        ...
        self._distance_integrator = TrapezoidalIntegrator(
            self._calculate_absolute_velocity()
        )
        self._elevation_integrator = TrapezoidalIntegrator(
    ...
    def write_command(
        ...
        accR=0.2,
        accL=0.2,
        maxVel=BERTEC_MAX_VEL,
        minVel=-BERTEC_MAX_VEL,
    ):
        """
