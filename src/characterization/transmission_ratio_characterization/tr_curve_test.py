# Script to visualize the Transmission Ratio Curve Output (data from TR_characterization_MAIN.py)
...
# TO USER: INSERT THE APPROPRIATE FULL DATA FILE HERE
with open("default_TR_fulldata_left_2025_04_23_11_02.csv", newline='') as file:
