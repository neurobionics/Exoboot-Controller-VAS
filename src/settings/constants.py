...
TR_FOLDER_PATH = (
    "./src/characterization/transmission_ratio_characterization/TR_coef_logs/"
)
TEST_TR_FILE = "default_TR_coefs_left_2025_02_04_16_13.csv"

""" Assistance Timing """
# tuned for VAS study
INCLINE_WALK_TIMINGS = SPLINE_PARAMS(P_RISE=15, P_PEAK=54, P_FALL=12, P_TOE_OFF=67)

# Varun's Pref Optimized Params for 1.20m/s:
FLAT_WALK_TIMINGS = SPLINE_PARAMS(P_RISE=27.9, P_PEAK=53.3, P_FALL=7, P_TOE_OFF=65)
...
EXO_CURRENT_SAFETY_LIMITS = EXO_CURRENT_SAFETY_CONSTANTS(
    ZERO_CURRENT=0, MAX_ALLOWABLE_CURRENT=17000  # mA  # mA
)
