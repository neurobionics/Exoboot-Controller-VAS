function exoboot_compiled_data = Vickrey_exoboot_data_packager(subj_num)
    % VAS_exoboot_data_packager -- 
    %   Extract files from zip-archive for Vickrey EPO
    %
    ...
    % compress the file
    zip('zipped_Vickrey_exoboot_data','Vickrey_exoboot_data.mat');

    % remove the unzipped struct
    delete Vickrey_exoboot_data.mat
end