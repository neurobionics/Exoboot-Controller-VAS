...
% This code plots the $-value over time for each participant.
%
...
%% For each participant, create a plot with time series data charted for each torque for each trial
